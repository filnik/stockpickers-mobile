 ...
 */
@Single
class RefreshPriceSeriesUseCase(private val repository: TickerRepository) {
    suspend operator fun invoke(ticker: String, range: ChartRange) = repository.refreshPriceSeries(ticker, range)
}
